        ...
        <div className={`bg-gradient-to-br from-orange-50 to-amber-50 rounded-2xl p-8 border border-orange-100 transition-all duration-700 delay-400 ${
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="space-y-4">
              <div>
                <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-1">Rajesh Kumar</h3>
                ...
                <div className="space-y-3 text-gray-700 leading-relaxed">
                  ...
                  <p className="text-sm">
                    With over 20 years of experience in renewable energy, Rajesh founded Bharat Infra in 2010 with a mission to democratize solar power across India. His commitment to quality and customer satisfaction has made Bharat Infra a trusted name in the industry.
                  </p>
